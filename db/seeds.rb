...
Country.create!(name: 'Germany', iso: 'DE', activated: true)
...
de = Country.find_by(iso: 'DE')
State.create!(iso: "01", name: "Baden-Württemberg", country_id: de.id)
State.create!(iso: "02", name: "Bavaria", country_id: de.id)
State.create!(iso: "05", name: "Hesse", country_id: de.id)
State.create!(iso: "07", name: "North Rhine-Westphalia", country_id: de.id)
State.create!(iso: "08", name: "Rhineland-Palatinate", country_id: de.id)
State.create!(iso: "09", name: "Saarland", country_id: de.id)
State.create!(iso: "11", name: "Brandenburg", country_id: de.id)
State.create!(iso: "12", name: "Mecklenburg-Vorpommern", country_id: de.id)
State.create!(iso: "13", name: "Saxony", country_id: de.id)
State.create!(iso: "14", name: "Saxony-Anhalt", country_id: de.id)
State.create!(iso: "15", name: "Thuringia", country_id: de.id)

es = Country.find_by(iso: 'ES')
State.create(iso: "51", name: "Andalusia", country_id: es.id)
State.create(iso: "52", name: "Aragon", country_id: es.id)
State.create(iso: "CE", name: "Ceuta", country_id: es.id)
State.create(iso: "ML", name: "Melilla", country_id: es.id)
State.create(iso: "55", name: "Castile and León", country_id: es.id)
State.create(iso: "54", name: "Castille-La Mancha", country_id: es.id)
State.create(iso: "53", name: "Canary Islands", country_id: es.id)
State.create(iso: "56", name: "Catalonia", country_id: es.id)
State.create(iso: "57", name: "Extremadura", country_id: es.id)
State.create(iso: "58", name: "Galicia", country_id: es.id)
State.create(iso: "07", name: "Balearic Islands", country_id: es.id)
State.create(iso: "27", name: "La Rioja", country_id: es.id)
State.create(iso: "29", name: "Madrid", country_id: es.id)
State.create(iso: "31", name: "Murcia", country_id: es.id)
State.create(iso: "32", name: "Navarre", country_id: es.id)
State.create(iso: "34", name: "Asturias", country_id: es.id)
State.create(iso: "59", name: "Basque Country", country_id: es.id)
